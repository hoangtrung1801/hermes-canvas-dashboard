...
- Add a Python CLI at `skills/canvas-dashboard/scripts/canvas_dashboard_tool.py`.
...
Add `skills/canvas-dashboard/scripts/canvas_dashboard_tool.py` as a standalone Python script invoked with:
...
4. Hermes calls `python3 skills/canvas-dashboard/scripts/canvas_dashboard_tool.py --actions '<json action array>'`.
