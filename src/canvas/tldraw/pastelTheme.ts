...
function pastelColor(base: TLDefaultColor, value: string, text = '#111827'): TLDefaultColor {
  return {
    ...base,
    solid: value,
    semi: value,
...
function pastelPalette(
  ...
  return {
    ...
    'light-violet': pastelColor(colors['light-violet'], palette['light-violet'], text),
    violet: pastelColor(colors.violet, palette.violet, text),
    blue: pastelColor(colors.blue, palette.blue, text),
    'light-blue': pastelColor(colors['light-blue'], palette['light-blue'], text),
    ...
    'light-green': pastelColor(colors['light-green'], palette['light-green'], text),
