...
describe('createTidyCardLayout', () => {
  it('arranges todo, note, and link cards into type columns', () => {
    ...
    expect(result).toEqual([
      { id: 'shape:todo_1', type: 'todo_block', x: 300, y: 100 },
      { id: 'shape:todo_2', type: 'todo_block', x: 300, y: 352 },
      { id: 'shape:note_1', type: 'geo', x: 716, y: 100 },
      { id: 'shape:link_1', type: 'link_card', x: 1092, y: 100 }
    ])
  })
