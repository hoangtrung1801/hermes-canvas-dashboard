...
describe('createTidyCardLayout', () => {
  it('arranges todo, note, and link cards into type columns', () => {
    const result = createTidyCardLayout([
      shape('shape:project_1', 'project_card', 100, 300, { w: 960, h: 480 }),
    ...
    expect(result).toEqual([
      ...
      { id: 'shape:todo_1', type: 'todo_block', x: 1116, y: 100 },
      { id: 'shape:todo_2', type: 'todo_block', x: 1116, y: 352 },
      { id: 'shape:note_1', type: 'geo', x: 1532, y: 100 },
      { id: 'shape:link_1', type: 'link_card', x: 1908, y: 100 }
    ])
  })
